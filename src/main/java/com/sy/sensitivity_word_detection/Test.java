...
//        test3();
    ...
    public static void test1() {
        ...
        // 根据敏感词,初始化敏感词搜索器
        var kwSeeker1 = new WordDetector(kws1);
        var kwSeeker2 = new WordDetector(kws2);

        // 搜索器组,构建敏感词管理器,可同时管理多个搜索器，map的key为自定义搜索器标识
        var seekers = new HashMap<String, WordDetector>();
...
//        System.out.println("contains: " + kwSeeker.isContainsSensitivity(text1));
    ...
    public static void test3() {
        ...
        WordDetector kwSeeker = new WordDetector(kws);
